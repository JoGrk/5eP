...
CREATE USER 'edytor' 
GRANT UPDATE,DELETE,INSERT,SELECT ON perfumy.* TO 'edytor';
-- 3. Utwórz użytkownika selektor z prawami do wyszukiwania danych w tabeli perfumy z hasłem 1234
CREATE USER 'selektor' IDENTIFIED BY '1234';
GRANT SELECT ON perfumy.perfumy TO 'selektor';
-- 4. Nadaj hasło użytkownikowi edytor 1234 oraz użytkownikowi selektor 5678
SET PASSWORD FOR "edytor" = PASSWORD("1234");
SET PASSWORD FOR "selektor" = PASSWORD("5678");
-- 5. Odbierz użytkownikowi edytor prawo do usuwania danych z wszystkich tabel
REVOKE DELETE ON perfumy.* FROM 'edytor';
